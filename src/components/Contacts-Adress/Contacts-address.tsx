    ...
    return (
        <article className='py-16 space-y-8 px-4'>
            ...
            <div className='flex gap-4 justify-center flex-wrap sm:justify-between'>
                <div className='w-80 flex gap-2 items-start  bg-slate-100 dark:bg-slate-600 py-4 px-4 rounded'>
                ...
                <div className='w-80 flex gap-4 items-start bg-slate-100 dark:bg-slate-600 py-4 px-4 rounded'>
